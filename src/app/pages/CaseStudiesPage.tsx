            ...
            <div className="grid md:grid-cols-2">
              <div className="p-10 md:p-14 space-y-6">
                ...
                <div className="space-y-4 text-sm text-[#475569] leading-relaxed">
                  <div><span className="font-medium text-[#0B1F3A]">Challenge: </span>Mission-critical IBM Sterling EDI environment required modernization, partner onboarding, and 24×7 reliability across a global logistics network</div>
                  <div><span className="font-medium text-[#0B1F3A]">Solution: </span>Delivered end-to-end EDI modernization, partner onboarding, platform administration, production support, and Oracle Integration Cloud operations</div>
                ...
                <div className="border-t border-[#0B1F3A]/10 pt-6 space-y-3">
                  ...
                  <p className="text-base text-[#0B1F3A] font-medium">100+ trading partners onboarded, zero critical migration outages, and expanded support across 4 integration service lines while maintaining uninterrupted operations</p>
              ...
              <div className="bg-[#1A73E8]/[0.02] border-l border-[#0B1F3A]/10 p-10 md:p-14 flex flex-col justify-between">
                <div>
                  ...
                  <div className="space-y-6">
                    {[
                      { metric: "5+ Years", label: "Faster partner onboarding" },
                      { metric: "100+", label: "Trading Partners Onboarded" },
                      { metric: "$1.3M+", label: "Annual Costs Saved" },
                      { metric: "98%+", label: "EDI Success Rate" },
                      { metric: "67%", label: "Reduction in Support FTEs" },
                      { metric: "0", label: "Critical Migration Outages" },
